---
title: Functions
tags: [bash, functions, recursion, arrays]
status: complete
...
## [Pasing arrays](examples/pass_array.sh)

## [Retornando valores de una función](examples/return_values.sh)
...
[Ejemplo de como calcular un número factorial](examples/factorial.sh)
