...
tags: [bash, loops, for, while, until, IFS]
status: complete
...
[Ej: Mostrar archivos abiertos por los usarios en bash](examples/06hello7.sh)
...
Es la forma que por defecto bash toma los `separadores` para ingresar sus campos de variables. Para cambiar este comportamiento que vemos en [06IFS.sh](examples/06IFS.sh) vamos modificar el IPS.
...
[Ejemplo](examples/06fileDirectories.sh)

### C-Style for loops

[C-Style code](examples/06cstyle.sh)
